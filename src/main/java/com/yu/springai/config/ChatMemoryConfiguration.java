...
import com.yu.springai.entity.po.AiChatMemory;
import com.yu.springai.mapper.AiChatMemoryMapper;
...
@Component
public class ChatMemoryConfiguration implements ChatMemory{
    @Autowired
